...
class ITemporalProcessor {
 public:
  ...
  virtual bool Prepare(std::uint32_t width, std::uint32_t height, const TemporalConfig& config) = 0;
  virtual bool Process(const runtime::FrameInput& input, TemporalResult& result) = 0;
